...
export const translations: Record<string, Record<string, string>> = {
  ...
  mni: { start: "Take The Audit Today", next: "Next Question →", analyze: "Analyze Security", posture: "Security Posture", priority: "Priority Actions", download: "DOWNLOAD FULL REPORT (PDF)", badge: "DOWNLOAD BADGE 📸", generating: "GENERATING...", systemsSecure: "SYSTEMS SECURE" }
};
